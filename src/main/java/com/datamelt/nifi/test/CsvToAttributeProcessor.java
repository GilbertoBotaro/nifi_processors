...
public class CsvToAttributeProcessor extends AbstractProcessor
{
    ...
    public static final PropertyDescriptor ATTRIBUTE_PREFIX = new PropertyDescriptor.Builder()
            ...
            .description("Specify which String is used to prefix the attributes. If the prefix is e.g. \"column\" then the attributes will be named: \"column0\", \"column1\",\"column2\", etc.")
            .build();
